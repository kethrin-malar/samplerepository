...
public class IndertingValueForBlob {
   public static void main(String args[]) throws Exception{
      ...
      FileInputStream fin = new FileInputStream("C:\\Users\\LENOVO\\Pictures\\flower.jpg");
      pstmt.setBinaryStream(2, fin);
      pstmt.execute();
      System.out.println("Record inserted .....");
      Statement stmt = con.createStatement();
      ResultSet rs = stmt.executeQuery("select * from Mytable where name = 'sample_image4';");
      int i = 1;
      ...
      while(rs.next()) {
         ...
         FileOutputStream("C:\\Users\\LENOVO\\Pictures\\flower1.jpg");
